    ...
    >
      ...
      <div className="container-width section-spacing grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        <div className="space-y-8 animate-fade-in">
          <div>
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-lg">
              Crafting compelling narratives and visuals that drive engagement and conversions.
            </p>
          </div>
          ...
          <div className="pt-6 inline-flex space-x-4">
            <div className="text-sm font-medium">Follow Me:</div>
        ...
        <div className="relative">
          <div className="aspect-square w-full max-w-lg mx-auto relative overflow-hidden rounded-2xl">
            <img
              ref={imageRef}
              ...
              className="object-cover w-full h-full transform transition-transform duration-700 ease-out scale-105 animate-fade-in"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-background/20 to-transparent"></div>
          </div>
          
          {/* Decorative elements */}
          <div className="absolute -top-5 -left-5 w-20 h-20 border-t-2 border-l-2 border-primary/20 rounded-tl-lg"></div>
          <div className="absolute -bottom-5 -right-5 w-20 h-20 border-b-2 border-r-2 border-primary/20 rounded-br-lg"></div>
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center animate-subtle-bounce">
