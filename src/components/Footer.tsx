...
const Footer = () => {
  ...
  return (
    <footer className="bg-background border-t border-border/30">
      <div className="container-width py-12 px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-muted-foreground max-w-md">
              Crafting compelling social media content that transforms brands, drives engagement, and delivers measurable results.
            </p>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mt-12 pt-8 border-t border-border/30">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="mt-4 sm:mt-0 rounded-full hover:bg-secondary"
            onClick={scrollToTop}
